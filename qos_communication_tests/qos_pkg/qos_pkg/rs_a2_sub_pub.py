...
class QoSImageSubPub(Node):
    ...
    def sub_callback(self, msg):
        ...
        msg2 = ImageStampId()
        msg2.image = msg
        msg2.id = self.counter
        time_ns = rclpy.time.Time.from_msg(msg.header.stamp)
        msg2.stamp_ns = time_ns.nanoseconds
        msg2.stamp_ns2 = self.get_clock().now().nanoseconds
        self.publisher_2.publish(msg2)
        #self.get_logger().info(f'Receiving messages {id} @ {msg2.stamp_ns2}')
