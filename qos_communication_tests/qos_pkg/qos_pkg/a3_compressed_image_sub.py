...
delimiter = ';'
output_dir = "docs/data/image_compressed_one_way/"
...
class QoSImageSub(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            'qos_compressed_image/pub2',
            self.sub_callback,
            qos_profiles_dict[self.qos_profile]#,event_callbacks=self.subscription_callbacks
        )
        self.publisher_ = self.create_publisher(CompressedImage, 'rs_camera/comrpessed_image', 10)
