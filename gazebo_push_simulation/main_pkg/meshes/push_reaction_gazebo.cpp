...
int main(int argc, char * argv[])
{
  ...
  std::shared_ptr<rclcpp::Node> node = rclcpp::Node::make_shared("push_experiment_02");

  auto gazebo_node = std::make_shared<push_experiment_02::GazeboNode>();
